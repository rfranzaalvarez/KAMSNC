...
// ============ STATUS CONFIG (usado en ChannelsPage, PipelinePage, etc.) ============
...
// ============ PIPELINE CONFIG (stage → label, usado en ChannelsPage y AssistantPage) ============
...
// ============ PIPELINE STAGES (array completo para PipelinePage/DashboardPage) ============
...
// Stages que cuentan como "en proceso activo"
...
// ============ TIPO DE CANAL CAES ============
// Alias para compatibilidad con ChannelsPage (TIPO_CANAL_CAES_OPTIONS)
export const TIPO_CANAL_CAES_OPTIONS = [
  'Instalador',
  'Fabricante',
  'Distribuidor',
  'Asociación',
...
// Alias legacy
export const CANAL_CAES_TYPES = TIPO_CANAL_CAES_OPTIONS;
...
// ============ POTENCIAL ============
// Array de strings para selectores simples (ChannelsPage)
export const POTENCIAL_OPTIONS = ['Bajo', 'Medio', 'Alto', 'Muy Alto'];

// Array de objetos para badges con color (otros componentes)
...
// ============ ORIGEN DEL LEAD ============
// Array de objetos {value, label} para ChannelsPage y AssistantPage
